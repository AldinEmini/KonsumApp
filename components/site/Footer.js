    ...
    <footer className="bg-neutral-900 text-neutral-300">
      <div className="container py-14 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            <a href={SITE.social.facebook} className="p-2 rounded-full bg-neutral-800 hover:bg-[#E30613] transition"><Facebook className="h-4 w-4"/></a>
            <a href={SITE.social.instagram} className="p-2 rounded-full bg-neutral-800 hover:bg-[#E30613] transition"><Instagram className="h-4 w-4"/></a>
            <a href={SITE.social.youtube} className="p-2 rounded-full bg-neutral-800 hover:bg-[#E30613] transition"><Youtube className="h-4 w-4"/></a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-start gap-2"><MapPin className="h-4 w-4 mt-0.5 text-[#FFC72C]"/> {SITE.address}</li>
            <li className="flex items-center gap-2"><Phone className="h-4 w-4 text-[#FFC72C]"/> {SITE.phone}</li>
            <li className="flex items-center gap-2"><Mail className="h-4 w-4 text-[#FFC72C]"/> {SITE.email}</li>
            <li className="flex items-start gap-2"><Clock className="h-4 w-4 mt-0.5 text-[#FFC72C]"/> {SITE.hours}</li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-neutral-800">
        <div className="container py-5 flex flex-col md:flex-row items-center justify-between text-xs text-neutral-500">
          <p>© {new Date().getFullYear()} Konsum. Të gjitha të drejtat e rezervuara.</p>
