...
import { ChevronLeft, ChevronRight, Tag, Truck, Award, Clock, ArrowRight, Search, Flame, Loader2 } from 'lucide-react'
...
function Home() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      setOffers(o.offers || [])
      if (c.content?.hero_slides?.length) setSlides(c.content.hero_slides)
      setLoading(false)
    })
  }, [])
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative">
        <div className="overflow-hidden" ref={emblaRef}>
          <div className="flex">
            {slides.map((s, i) => (
              <div key={s.id || i} className="flex-[0_0_100%] min-w-0 relative">
