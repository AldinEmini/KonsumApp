    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="konsum-gradient text-white py-12 md:py-16">
        <div className="container">
          <Badge className="bg-[#20A33A] text-white font-bold mb-3">NË SHÌRBIMIN TUAJ</Badge>
      ...
      <section className="py-10">
        <div className="container">
          <div className="flex items-end justify-between mb-6">
            <div>
              <Badge className="bg-orange-50 text-[#EF7B22] hover:bg-orange-50 mb-2">12 lokacione</Badge>
