      ...
      <section className="relative h-[360px] md:h-[460px] overflow-hidden">
        ...
        <div className="container relative h-full flex items-center text-white">
          <div className="max-w-2xl space-y-4">
            <Badge className="bg-[#20A33A] text-white font-bold hover:bg-[#20A33A]">SINCE 1991</Badge>
        ...
        <div className="container grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm" id="derguar">
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li className="flex gap-2"><span className="text-[#20A33A]">✓</span> Falas mbi 2000 MKD</li>
              <li className="flex gap-2"><span className="text-[#20A33A]">✓</span> Brenda 2 orësh në Shkup</li>
              <li className="flex gap-2"><span className="text-[#20A33A]">✓</span> Pagesa me kesh ose kartë</li>
            </ul>
          </div>
        </div>
      </section>
